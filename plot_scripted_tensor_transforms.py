...
# added by Holy 2108231500
dog1 = read_image(str(Path(r'd:\data\cats_dogs\test_set\test_set\dogs') / 'dog.4001.jpg'))
dog2 = read_image(str(Path(r'd:\data\cats_dogs\test_set\test_set\dogs') / 'dog.4002.jpg'))
# end of addition 2108231500

cat1 = read_image(str(Path(r'd:\data\cats_dogs\test_set\test_set\cats') / 'cat.4001.jpg'))
