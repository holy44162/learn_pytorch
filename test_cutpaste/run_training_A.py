...
def run_training(data_type="screw",
    ...
    train_data = MVTecAT_C("d:/temp/mvtec_anomaly_detection", data_type, transform = [train_transform_B1, train_transform_B2], size=int(size * (1/min_scale))) # added by Holy 2111020810
