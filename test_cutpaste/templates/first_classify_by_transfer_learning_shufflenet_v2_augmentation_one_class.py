...
if __name__ == "__main__":
    ...
    checkpoint_path = './checkpoint_one_class/current_checkpoint.pt'
    best_model_path = './best_model_one_class/best_model.pt'
    ...
    if resume_training:        
        ...
        # added by Holy 2110280810
        latest_best_model_path = 'latest_best_shufflenet_model_one_class.pth'
        ...
        fine_tune = False
        if fine_tune:
            base_model_path = './base_model_one_class/base_shufflenet_model_one_class.pth'
    ...
    # save model_ft
    torch.save(model_ft.state_dict(), 'model_ft_weights_shufflenet_v2_one_class.pth')
        
    model_ft.eval()

    # Saving Model_ft with Shapes
    torch.save(model_ft, 'model_ft_shufflenet_v2_one_class.pth')
